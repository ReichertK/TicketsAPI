...
INSERT INTO `audit_config` VALUES (3,'departamento',85,'TOGGLE','activo','1','0',1,'Administrador','2026-02-20 16:31:55','Departamento Desactivado: AuditTest_Updated'),(4,'departamento',86,'INSERT',NULL,NULL,'<script>alert(123)</script> emoji_test kanji_test',1,'Administrador','2026-02-20 17:43:30','Departamento creado: <script>alert(123)</script> emoji_test kanji_test'),(5,'departamento',87,'TOGGLE','activo','1','0',1,'Administrador','2026-02-24 14:07:25','Departamento Desactivado: Depto UTF8MB4 ?'),(6,'departamento',59,'TOGGLE','activo','1','0',1,'Administrador','2026-02-27 17:16:52','Departamento Desactivado: Administraci├│n'),(7,'departamento',59,'TOGGLE','activo','0','1',1,'Administrador','2026-02-27 17:16:55','Departamento Activado: Administraci├│n'),(8,'departamento',33,'TOGGLE','activo','1','0',1,'Administrador','2026-03-03 12:36:39','Departamento Desactivado: Caja / Facturaci├│n / Autorizaciones'),(9,'departamento',33,'TOGGLE','activo','0','1',1,'Administrador','2026-03-03 12:36:42','Departamento Activado: Caja / Facturaci├│n / Autorizaciones'),(10,'rol',1,'UPDATE','nombre',NULL,'Supervisor',1,'Administrador','2026-03-03 12:37:12','Rol actualizado: Supervisor');
...
INSERT INTO `audit_log` VALUES (5,'tkt_transicion',2,'INSERT',1,'Admin',NULL,'{\"ticket\":1,\"estado_from\":2,\"estado_to\":6,\"asignado_old\":null,\"asignado_new\":null}','2026-07-02 15:30:17',NULL,'Ticket #1 transicion de estado 2 -> 6'),(6,'tkt',1,'DELETE',1,'Admin','{\"estado\":6,\"prioridad\":null,\"departamento\":null,\"asignado\":1,\"contenido\":\"TEST transicion 2->6 (borrar)\"}',NULL,'2026-07-02 15:30:17',NULL,'Ticket #1 eliminado');
...
INSERT INTO `departamento` VALUES (1,'Departamento A',NULL,1,NULL),(2,'Departamento B',NULL,1,NULL),(3,'Departamento C',NULL,1,NULL),(4,'Mesa de Ayuda / Soporte N1',NULL,1,NULL),(5,'Soporte N2 / Plataformas',NULL,1,NULL),(6,'Infraestructura',NULL,1,NULL),(7,'Redes',NULL,1,NULL),(8,'Telecomunicaciones',NULL,1,NULL),(9,'Seguridad Inform├ítica',NULL,1,NULL),(10,'Desarrollo de Software',NULL,1,NULL),(11,'QA / Testing',NULL,1,NULL),(12,'Bases de Datos / DBA',NULL,1,NULL),(13,'Aplicaciones Corporativas / ERP',NULL,1,NULL),(14,'BI / Anal├¡tica',NULL,1,NULL),(15,'Gesti├│n de Servicios (ITSM)',NULL,1,NULL),(16,'Ventas / Comercial',NULL,1,NULL),(17,'Atenci├│n al Cliente',NULL,1,NULL),(18,'Operaciones',NULL,1,NULL),(19,'Log├¡stica',NULL,1,NULL),(20,'Producci├│n',NULL,1,NULL),(21,'Calidad',NULL,1,NULL),(22,'Compras / Abastecimiento',NULL,1,NULL),(23,'Finanzas / Contabilidad',NULL,1,NULL),(24,'Tesorer├¡a',NULL,1,NULL),(25,'Cr├®ditos y Cobranzas',NULL,1,NULL),(26,'Recursos Humanos',NULL,1,NULL),(27,'Marketing / Comunicaci├│n',NULL,1,NULL),(28,'Legal',NULL,1,NULL),(29,'Direcci├│n / Gerencia',NULL,0,'2026-02-10 14:02:37'),(30,'Sucursales / Oficinas',NULL,1,NULL),(31,'Recepci├│n y Admisi├│n',NULL,1,NULL),(32,'Turnos / Call Center',NULL,1,NULL),(33,'Caja / Facturaci├│n / Autorizaciones',NULL,1,NULL),(34,'Atenci├│n al Paciente',NULL,1,NULL),(35,'Radiolog├¡a Convencional (Rayos X)',NULL,1,NULL),(36,'Tomograf├¡a Computada (TC)',NULL,1,NULL),(37,'Resonancia Magn├®tica (RM)',NULL,1,NULL),(38,'Ecograf├¡a',NULL,1,NULL),(39,'Mamograf├¡a',NULL,1,NULL),(40,'Densitometr├¡a ├ôsea (DEXA)',NULL,1,NULL),(41,'Medicina Nuclear',NULL,1,NULL),(42,'Radiolog├¡a Intervencionista / Hemodinamia',NULL,1,NULL),(43,'M├®dicos Informantes (Radiolog├¡a)',NULL,1,NULL),(44,'T├®cnicos Radi├│logos',NULL,1,NULL),(45,'Jefatura de Diagn├│stico por Im├ígenes',NULL,1,NULL),(46,'Protecci├│n Radiol├│gica / F├¡sica M├®dica',NULL,1,NULL),(47,'Archivo y Entrega de Estudios',NULL,1,NULL),(48,'Calidad Cl├¡nica / Protocolos',NULL,1,NULL),(49,'Consultorios',NULL,1,NULL),(50,'Kinesiolog├¡a y Rehabilitaci├│n',NULL,1,NULL),(51,'Sistemas / Soluciones IT',NULL,1,NULL),(52,'PACS / RIS',NULL,1,NULL),(53,'Integraciones HIS/EMR (HL7/DICOM)',NULL,1,NULL),(54,'Seguridad de la Informaci├│n',NULL,1,NULL),(55,'Mantenimiento Edilicio',NULL,1,NULL),(56,'Mantenimiento Biom├®dico',NULL,1,NULL),(57,'Compras / Suministros (Insumos Radiol├│gicos)',NULL,1,NULL),(58,'Servicios Generales / Limpieza',NULL,1,NULL),(59,'Administraci├│n',NULL,1,NULL),(60,'Legales y Compliance',NULL,1,NULL),(61,'Calidad y Auditor├¡a',NULL,1,NULL),(62,'Marketing / Comunicaci├│n Institucional',NULL,1,NULL),(63,'Direcci├│n M├®dica',NULL,1,NULL),(64,'Direcci├│n General / Gerencia',NULL,1,NULL),(65,'Sistemas',NULL,1,NULL),(66,'Comercial',NULL,1,NULL),(68,'RRHH',NULL,1,NULL),(83,'Finanzas','Departamento de Finanzas',1,NULL),(87,'Depto UTF8MB4 ?','Kanji Õà¿þÉâ',0,'2026-02-24 11:07:25');
...
INSERT INTO `estado` VALUES (1,'Abierto',NULL,1,NULL),(2,'En Proceso',NULL,1,NULL),(3,'Cerrado',NULL,1,NULL),(4,'En Espera',NULL,1,NULL),(5,'Pendiente Aprobaci├│n',NULL,1,NULL),(6,'Resuelto',NULL,1,NULL),(7,'Reabierto',NULL,1,NULL);
...
INSERT INTO `motivo` VALUES (1,'Motivo A',NULL,NULL,NULL,1,NULL),(2,'Motivo B',NULL,NULL,NULL,1,NULL),(3,'Motivo C',NULL,NULL,NULL,1,NULL),(4,'Turno / Reprogramaci├│n',NULL,NULL,NULL,1,NULL),(5,'Autorizaci├│n de Obra Social',NULL,NULL,NULL,1,NULL),(6,'Facturaci├│n / Cobranza',NULL,NULL,NULL,1,NULL),(7,'Recepci├│n / Admisi├│n',NULL,NULL,NULL,1,NULL),(8,'Entrega de Estudios / Duplicado',NULL,NULL,NULL,1,NULL),(9,'Satisfacci├│n del Paciente / Queja',NULL,NULL,NULL,1,NULL),(10,'Rayos X - Orden / Preparaci├│n',NULL,NULL,NULL,1,NULL),(11,'Rayos X - Resultado / Entrega',NULL,NULL,NULL,1,NULL),(12,'Tomograf├¡a - Orden / Preparaci├│n',NULL,NULL,NULL,1,NULL),(13,'Tomograf├¡a - Contraste / Reacci├│n',NULL,NULL,NULL,1,NULL),(14,'Resonancia - Orden / Preparaci├│n',NULL,NULL,NULL,1,NULL),(15,'Resonancia - Implantes / Contraindicaciones',NULL,NULL,NULL,1,NULL),(16,'Ecograf├¡a - Agenda / Preparaci├│n',NULL,NULL,NULL,1,NULL),(17,'Mamograf├¡a - Orden / Preparaci├│n',NULL,NULL,NULL,1,NULL),(18,'DEXA - Orden / Preparaci├│n',NULL,NULL,NULL,1,NULL),(19,'Informe - Retraso',NULL,NULL,NULL,1,NULL),(20,'Informe - Aclaraci├│n / Addendum',NULL,NULL,NULL,1,NULL),(21,'Informe - Correcci├│n de Datos',NULL,NULL,NULL,1,NULL),(22,'PACS - Visualizaci├│n de Im├ígenes',NULL,NULL,NULL,1,NULL),(23,'PACS - Env├¡o/Recepci├│n DICOM',NULL,NULL,NULL,1,NULL),(24,'RIS - Agenda / Admisi├│n',NULL,NULL,NULL,1,NULL),(25,'RIS - Falla de Integraci├│n',NULL,NULL,NULL,1,NULL),(26,'HIS/EMR - Interfaz HL7',NULL,NULL,NULL,1,NULL),(27,'Portal Paciente / M├®dicos - Acceso',NULL,NULL,NULL,1,NULL),(28,'Equipamiento RX - Falla',NULL,NULL,NULL,1,NULL),(29,'Tom├│grafo - Falla',NULL,NULL,NULL,1,NULL),(30,'Resonador - Falla',NULL,NULL,NULL,1,NULL),(31,'Ec├│grafo - Falla',NULL,NULL,NULL,1,NULL),(32,'Mam├│grafo - Falla',NULL,NULL,NULL,1,NULL),(33,'Impresora Dry - Falla / Insumos',NULL,NULL,NULL,1,NULL),(34,'CR/DR - Digitalizador - Falla',NULL,NULL,NULL,1,NULL),(35,'Protecci├│n Radiol├│gica',NULL,NULL,NULL,1,NULL),(36,'Calibraci├│n / Control de Calidad',NULL,NULL,NULL,1,NULL),(37,'Gesti├│n de Incidentes (Seguridad Info)',NULL,NULL,NULL,1,NULL),(38,'Kinesiolog├¡a - Agenda / Pr├íctica',NULL,NULL,NULL,1,NULL),(39,'Consultorios - Agenda / Atenci├│n',NULL,NULL,NULL,1,NULL),(40,'Infraestructura - Climatizaci├│n',NULL,NULL,NULL,1,NULL),(41,'Infraestructura - Electricidad',NULL,NULL,NULL,1,NULL),(42,'Servicios - Limpieza / Residuos Patol├│gicos',NULL,NULL,NULL,1,NULL),(43,'Incidente',NULL,'Soporte',NULL,1,NULL),(44,'Solicitud',NULL,'Servicio',NULL,1,NULL),(45,'Consulta',NULL,'Informaci├│n',NULL,1,NULL),(60,'Error de Factura','Error en facturaci├│n','Finanzas',NULL,0,'2026-02-20 11:32:26');
...
INSERT INTO `prioridad` VALUES (1,'Alta',NULL,1,NULL),(2,'Media',NULL,1,NULL),(3,'Baja',NULL,1,NULL),(7,'Cr├¡tica',NULL,1,NULL);
...
INSERT INTO `sistema` VALUES ('CDK_AUT','AUTORIZACIONES',0),('CDK_CNS','CONSUMOS',0),('CDK_CNV','CONVENIOS',0),('CDK_EST','IM├üGENES',0),('CDK_FIS','FISIO',0),('CDK_HUB','HUB',0),('CDK_NYP','NORMAS Y PROCEDIMIENTOS',0),('CDK_PAD','PADR├ôN',0),('CDK_RYS','RECLAMOS/SUGERENCIAS',0),('CDK_STK','STOCK',0),('CDK_TKT','TICKETS',1),('CDK_TUR','TURNOS',0);
...
BEGIN
  ...
  ('tkt_comentario', NEW.id_comentario, 'INSERT', NEW.id_usuario,
   ...
   NEW.comentario,
   NOW(),
   CONCAT('Comentario ', NEW.id_comentario, ' a├▒adido al ticket ', NEW.id_tkt));
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
proc: BEGIN
  ...
  IF v_ticket_existe = 0 THEN
    SET p_resultado = 'Error: Ticket no existe o est├í inhabilitado';
    LEAVE proc;
  END IF;
  ...
  IF v_usuario_existe = 0 THEN
    SET p_resultado = CONCAT('Error: Usuario ', p_id_usuario_asignado, ' no existe o est├í inactivo');
    LEAVE proc;
  END IF;
    ...
    IF v_asignado_actual IS NOT NULL THEN
      ...
      IF p_comentario IS NULL OR TRIM(p_comentario) = '' THEN
        SIGNAL SQLSTATE '45000'
          SET MESSAGE_TEXT = 'Comentario obligatorio: debe justificar la reasignaci├│n del ticket';
      END IF;

      
      INSERT INTO tkt_comentario (id_tkt, id_usuario, comentario, fecha)
      VALUES (p_id_tkt, p_id_usuario_actor, CONCAT('[Reasignaci├│n] ', p_comentario), NOW());
    END IF;
  END IF;
...
-- Dump completed on 2026-07-02 12:38:06
